...
augroup vimrc
    ...
    autocmd BufWinEnter *.{md,mdwn,mkd,mkdn} nested setlocal filetype=markdown conceallevel=0 nofoldenable
...
let test#neovim#term_position = 'split topleft'
nnoremap <silent> <C-S> <Cmd>TestFile<CR>
